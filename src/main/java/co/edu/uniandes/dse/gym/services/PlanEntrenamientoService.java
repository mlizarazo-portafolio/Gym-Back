...
public class PlanEntrenamientoService {
    ...
    public PlanEntrenamientoEntity crearPlan(PlanEntrenamientoEntity planEntrenamientoEntity) throws IllegalOperationException{
        ...
        if(planEntrenamientoEntity.getDescripcion() == null) throw new IllegalOperationException("Descripcion no es válido");
        if(validateString(planEntrenamientoEntity.getDirrecion())) throw new IllegalOperationException("Dirrecion no es válido");
        if(planEntrenamientoEntity.getDuracion() == null) throw new IllegalOperationException("Duracion no es válido");
